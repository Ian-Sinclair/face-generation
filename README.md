...
The MNIST dataset was used to test model performance on small low complexity images, this was used to source a basis for the hyperparameters used on the larger datasets. The training of the generative model yielded compelling results, showcasing its ability to generate realistic handwritten digits. The following GIFs provide a visual representation of the training process:

- **Generated Images GIF**: This GIF showcases a selection of images generated by the model at different stages of training, demonstrating its capability to produce diverse and realistic digit representations.

- **Loss Visualization GIF**: This GIF illustrates the training progression by displaying the variation of the discriminator and generator losses over batches.
...
Training the generative model on the anime faces dataset resulted in impressive outcomes, capturing the unique features and characteristics of anime-style faces. The training progress is depicted through the following GIFs:

- **Generated Images GIF**: This GIF exhibits a collection of anime-style face images generated by the model, highlighting its proficiency in generating diverse and aesthetically pleasing outputs.

- **Loss Visualization GIF**: This GIF visualizes the discriminator and generator losses throughout the training process, providing insights into the model's convergence.
...
The training of the generative model on the celebrity faces dataset resulted in quality outcomes, generating lifelike facial images resembling famous personalities. The training progress is showcased through the following GIFs:

- **Generated Images GIF**: This GIF displays a selection of facial images generated by the model, demonstrating its ability to produce high-quality and realistic representations of celebrity faces.


<div style="text-align:center;">
  <img src="misc/images/celeb-faces-generated-images.gif" alt="Generated Images" width="60%">
</div>

### Final Results

After the completion of training, the model achieved remarkable results on all datasets. Below are side-by-side comparisons of samples of generated images from each dataset:

| MNIST Generated Images | Anime Faces Generated Images | Celebrity Faces Generated Images |
|------|-----|------|
| ![MNIST Samples](misc/images/mnist-final-generated-images.jpg) | ![Anime Faces Samples](misc/images/anime-faces-final-generated_images.jpg) | ![Celebrity Faces Samples](misc/images/celeb-faces-final-generated_images.jpg) |

These images demonstrate the model's proficiency in generating diverse and realistic images across different datasets.
